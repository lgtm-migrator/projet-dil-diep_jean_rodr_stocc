...
/**
 * This class represents a configuration of the website or of a page. It encapsulates a Map of
 * key/value pairs. Every Map that are passed in any function of this class would be copied to a new
 * Map to avoid any external changes.
 */
public class Config {
    /** The config Map. */
    ...
    /**
     * Config constructor from a map with a given key. The given map would be placed at given key in
     * the config map.
     *
    ...
    /**
     * Config constructor from another config with a given key. The given config's map would be
     * placed at given key in the new config map.
     *
     * @param key the key to use for the config.
     * @param config The configuration map.
     */
