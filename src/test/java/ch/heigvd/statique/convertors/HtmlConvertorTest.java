...
public class HtmlConvertorTest {
    private static final String defaultMdN =
            "# heading h1\n"
                + "## heading h2\n"
                + "### heading h2\n"
                + "#### heading h4\n"
    ...
    private static final String defaultMdRN =
            "# heading h1\r\n"
                + "## heading h2\r\n"
                + "### heading h2\r\n"
                + "#### heading h4\r\n"
    ...
    private static final String defaultHTML =
            "<h1>heading h1</h1>\n"
                ...
                + "</ul>\n"
                + "<hr />\n"
                + "<p><a href=\"https://www.mozilla.org/\"><img"
                + " src=\"https://mdn.github.io/beginner-html-site/images/firefox-icon.png\"></a><br"
                + " />\n"
                + "<a href=\"https://www.mozilla.org/\"><img"
                + " src=\"https://mdn.github.io/beginner-html-site/images/firefox-icon.png\""
                + " alt=\"Foo\" /></a><br />\n"
